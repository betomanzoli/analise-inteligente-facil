...
-- Insert initial notebooks with provided URLs
INSERT INTO public.notebooks (name, url, category, priority, description, user_id) VALUES 
('Notebook Principal 1', 'https://notebooklm.google.com/notebook/1bb10b1d-d4a5-4a50-a116-c035b1cf5489', 'regulatory', 5, 'Primeiro notebook principal para análises regulatórias', (SELECT auth.uid())),
('Notebook Principal 2', 'https://notebooklm.google.com/notebook/53dc0b5a-d7e0-4bf2-87f7-72f30fde635a', 'technical', 4, 'Segundo notebook para análises técnicas', (SELECT auth.uid())),
('Notebook Principal 3', 'https://notebooklm.google.com/notebook/f35c4ad5-c4bd-4efc-a36d-11ad2d003b75', 'support', 4, 'Terceiro notebook para suporte e análises gerais', (SELECT auth.uid()));